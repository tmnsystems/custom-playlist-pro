...
function AppContent() {
  ...
  return (
    <div className="flex h-screen flex-col bg-background">
      ...
      <header className="flex h-14 shrink-0 items-center justify-between border-b px-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold">CustomPlaylist</span>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Button
      ...
      <AddLinkDialog open={showAddLink} onOpenChange={setShowAddLink} />
            ...
            <div className="flex h-full flex-col items-center justify-center p-6">
              <div className="w-full max-w-md">
                <h1 className="mb-2 text-center text-2xl font-bold">
                  {playlists.length === 0 ? 'Welcome!' : 'Add Content'}
                </h1>
                <p className="mb-6 text-center text-muted-foreground">
                  Upload a PDF with video links, or use <strong>Add Link</strong> to paste any URL directly
                </p>
